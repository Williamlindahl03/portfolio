...
function Header() {
    ...
    return (
        <div className={`sticky top-2 z-100`}> 
            <div className={`w-[350px] max-w-full gap-1 m-auto grid auto-cols-fr grid-flow-col text-muted p-1 *:truncate rounded-full transition-all duration-200 overflow-hidden ${scrolled ? "outline outline-highlight bg-bgSecondary/80 backdrop-blur-xl shadow-lg shadow-black" : "py-1 outline-none shadow-none"}`}> 
